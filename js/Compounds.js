AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    for(var num =1;num<=numOfElectron;num++){
      ...
      var electronGroups=document.createElement("a-entity");
      electronGroups.setAttribute("id",`electron-group-${elementName}`);
      electronGroups.setAttribute("rotation",{
        x:0,
        y:0,
        z:electronAngle
      });
      ...
      electronGroups.setAttribute("animation",{
        property:"rotation",
        to:`0 0 -360`,
        loop:"true",
        dur:3500,
      ...
      orbit.appendChild(electronGroups);
      ...
      electronGroups.appendChild(electron);
    }
  }
});
